...
The terminal gets power through the USB-C connector. The BNC cable is connected to red line of the right [Grove](https://wiki.seeedstudio.com/Grove_System) socket (D1, pin 15).
